...
import ListLogo1 from "../../assets/img/VodafoneLogo2.png";
import ListLogo2 from "../../assets/img/EspressolabLogo.jpg";
import ListLogo3 from "../../assets/img/MaisonThomasLogo.jpg";
import ListLogo4 from "../../assets/img/FruitopiaLogo.jpg";
import ListLogo5 from "../../assets/img/BurdogzLogo.jpg";
import ListLogo6 from "../../assets/img/DickeysBarbequeLogo.jpg";
import ListLogo7 from "../../assets/img//AmelieLogo.jpg";
import ListLogo8 from "../../assets/img/joesLogo.jpg";
import ListLogo9 from "../../assets/img/929Logo.jpg";
import ListLogo10 from "../../assets/img/SultanaLogo.jpg";
import ListLogo11 from "../../assets/img/ChickenWorxLogo.jpg";
import ListLogo12 from "../../assets/img/SeecozLogo.jpg";
import ListLogo13 from "../../assets/img/CityEdgeDevelopmentLogo.jpg";
import ListLogo14 from "../../assets/img/MountainViewLogo.jpg";
import ListLogo15 from "../../assets/img/BadyaLogo.jpg";
  ...
  return (
    <div className="work-container">
      <div className="first-sec">
        <h3>
          An artist can capture the perfect moment anywhere, in any given
          situation.
        </h3>
        <div className="swip-contain">
          <Swiper
            style={{
              borderLeft: "3px solid #0e2337",
              borderRight: "3px solid #0e2337",
              borderRadius: "10px",
              borderBlockEnd: "3px solid #252525",
              borderBlockStart: "3px solid #252525",
            }}
            effect={"coverflow"}
            // grabCursor={true}
            centeredSlides={true}
